...
<div id="primary" class="content-area">
	<main id="main" class="site-main">
		<?php do_action('music_blog_before_default_page'); ?>
						...
						<div class="previous-post">
							...
							<div class="postarrow">
								<a href="<?php echo get_permalink($prev_post->ID); ?>">
									<i class="fa fa-long-arrow-left"></i><?php echo esc_html_e( 'Previous Post', 'music-blog' ); ?>
								</a>
							</div>
					...
					<div class="next-post">
						...
						<div class="postarrow">
							<a href="<?php echo get_permalink($next_post->ID); ?>">
								<?php echo esc_html_e( 'Next Post', 'music-blog' ); ?><i class="fa fa-long-arrow-right"></i>
							</a>
						</div>
		...
		<?php do_action('music_blog_after_default_page'); ?>
	</main><!-- #main -->
</div><!-- #primary -->
<?php
get_footer();
