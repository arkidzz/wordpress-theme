<?php
/**
 * music blog functions and definitions
 *
 * @link https://developer.wordpress.org/themes/basics/theme-functions/
 *
 * @package Music Blog
 */
if ( ! function_exists( 'music_blog_setup' ) ) :
	/**
	...
	function music_blog_setup() {
		...
		add_image_size( 'music-blog-thumbnail-mobile', 350, 350, true );
		add_image_size( 'music-blog-list-thumbnail', 380, 360, true );
		add_image_size( 'music-blog-grid-thumbnail', 380, 320, true );
		add_image_size( 'music-blog-thumbnail-medium', 770, 433.13, true );
		add_image_size( 'music-blog-thumbnail-large', 1200, 675, true );
		add_image_size( 'music-blog-thumbnail-featured', 930, 650, true );
		add_image_size( 'music-blog-header-full', 1920, 1080, true );
		add_image_size( 'music-blog-latest-post-widget-thumb', 120, 120, true );
		// This theme uses wp_nav_menu() in one location.
		register_nav_menus(
			array(
				'main-menu' => esc_html__( 'Primary', 'music-blog' ),
				'footer-menu' => esc_html__( 'Footer Menu', 'music-blog' ),
			)
		);
		...
		$custom_bg_args = apply_filters( 'music_blog_custom_background_args', array(
		...
		$GLOBALS['content_width'] = apply_filters( 'music_blog_content_width', 640 );
	}
endif;
add_action( 'after_setup_theme', 'music_blog_setup' );
