...
<article id="post-<?php the_ID(); ?>" <?php post_class( 'music-blog-standard-post' ); ?>>
	<div class="music-blog-standard-post__entry-content text-left">
		...
		<div class="music-blog-standard-post__content-wrapper">
			...
			<div class="music-blog-standard-post__blog-meta<?php echo esc_attr($nolinebetweenmeta);?>">
				<?php
			...
			<div class="music-blog-standard-post__full-summery text-left">
				<?php
					...
					wp_link_pages(
						array(
							'before' => '<div class="page-links">' . esc_html__( 'Pages:', 'music-blog' ),
							'after'  => '</div>',
						)
					);
					?>
